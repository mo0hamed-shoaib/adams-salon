...
export function Footer() {
  ...
  return (
    <footer className="border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 navigation">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="flex flex-col items-center justify-center gap-4 h-20 sm:h-16">
          <div className="flex items-center gap-4">
            ...
            <Link 
              href="https://mohamedgamal-loom.vercel.app/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors"
              aria-label="Developer: Jimmy"
            >
              <svg 
                width="16" 
                height="16" 
